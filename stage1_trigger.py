...
THRESHOLD_MULTIPLIER = 6.0   # conservative gate: ignore ordinary room fluctuations
MIN_ABSOLUTE_ENERGY = 0.02   # hard floor used by the previously stable demo trigger
MIN_BASELINE_BLOCKS = 20     # approximately two seconds of initial calibration
COOLDOWN_SECONDS = 1.5       # avoid repeated inference on one background event
